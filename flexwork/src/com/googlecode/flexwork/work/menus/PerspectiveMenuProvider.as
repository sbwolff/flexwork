...
{
	import com.googlecode.flexwork.core.components.ViewWindow;
	...
	public class PerspectiveMenuProvider extends AbstractMenuProvider implements IApplicationContextAware
	{
		...
		override public function appendMenuItem(parent:Object):void
		{
			...
			//
			var dockViews:Array=this._applicationContext.getObjectNamesForType(DockingView);
			var dockView:DockingView;
		...
		{
			var dockView:DockingView  = this._applicationContext.getObject(event.item.viewName) as DockingView;
