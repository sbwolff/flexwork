package com.googlecode.flexwork.core.components
{
	...
	public class SplitWindow extends DividedBox implements DockingWindow
	{
		...
		public function SplitWindow()
		{
			...
			this.addEventListener(DockingEvent.DOCKED, onViewDocked);
			this.addEventListener(DockingEvent.REMOVED, onViewRemoved);
...
//		public function setDirectionHorizontal(horizontal:Boolean):void
//		{
//			if (horizontal)
//			{
//				this.direction=BoxDirection.HORIZONTAL;
...
//			}
		...
		{
			if (BoxDirection.VERTICAL == direction)
			{
				return true;
			}
			return false;
