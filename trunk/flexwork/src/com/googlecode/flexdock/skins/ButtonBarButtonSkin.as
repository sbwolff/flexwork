package com.googlecode.flexdock.skins
{
	...
	public class ButtonBarButtonSkin extends Border
	{
		...
		override protected function updateDisplayList(w:Number, h:Number):void
		{
			...
			var borderColorDrk1:Number=ColorUtil.adjustBrightness2(borderColor, 0);
			...
			switch (name)
			{
				...
				{
					// button border/edge
					drawRoundRect(0, 0, w, h, cr, [themeColor, themeColorDrk1], 1, verticalGradientMatrix(0, 0, w, h), GradientType.LINEAR, null, {x: 2, y: 2, w: w - 4, h: h - 4, r: cr2});
				...
				case "upSkin":
				{
					...
					if (emph)
					{
						...
						drawRoundRect(2, 2, w - 4, (h - 4) / 2, radius, [0xFFFFFF, 0xFFFFFF], highlightAlphas, verticalGradientMatrix(2, 2, w - 2, (h - 4) / 2));
					}
					else
					{
						// button border/edge
						...
						drawRoundRect(1, 1, w - 2, (h - 2) / 2, radius, [0xFFFFFF, 0xFFFFFF], highlightAlphas, verticalGradientMatrix(1, 1, w - 2, (h - 2) / 2));
					}
					break;
				}
				...
				case "overSkin":
				{
					...
					// button border/edge
					drawRoundRect(0, 0, w, h, cr, [themeColor, derStyles.themeColDrk1], 1, verticalGradientMatrix(0, 0, w, h), GradientType.LINEAR, null, {x: 1, y: 1, w: w - 2, h: h - 2, r: cr1});
