package com.googlecode.flexdock.skins
{
	...
	public class ViewTabSkin extends Border
	{
		private static var cache:Object={};

		public function ViewTabSkin()
		{
			super();
		}
		...
		override protected function updateDisplayList(w:Number, h:Number):void
		{
			...
			switch (name)
			{
...

				{
					...
					// outer edge
					drawRoundRect(0, 0, w, h - 1, cr, [derStyles.borderColorDrk1, borderColor], 1, verticalGradientMatrix(0, 0, w, h), GradientType.LINEAR, null, {x: 1, y: 1, w: w - 2, h: h - 2, r: cr2});
				...
				case "overSkin":
				{
					...
					// outer edge
					drawRoundRect(0, 0, w, h - 1, cr, [themeColor, derStyles.themeColDrk2], 1, verticalGradientMatrix(0, 0, w, h - 6), GradientType.LINEAR, null, {x: 1, y: 1, w: w - 2, h: h - 2, r: cr2});
				...
				case "upSkin":
				{
					...
					// outer edge
					drawRoundRect(0, 0, w, h - 1, cr, [derStyles.borderColorDrk1, borderColor], 1, verticalGradientMatrix(0, 0, w, h - 2), GradientType.LINEAR, null, {x: 1, y: 1, w: w - 2, h: h - 2, r: cr2});

					// tab fill color
					drawRoundRect(1, 1, w - 2, h - 2, cr2, backgroundColor, backgroundAlpha);

					// tab bottom line
					//if(true)//if (drawBottomLine)
					//{
