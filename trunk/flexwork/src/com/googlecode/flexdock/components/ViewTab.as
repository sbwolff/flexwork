package com.googlecode.flexdock.components
{
	...
	public class ViewTab extends Tab
	{
		...
		public function ViewTab()
		{
			...
			this.setStyle("fillColors", [0xFFFFFF, 0xECE9D8]);
		...
		private function onCloseButtonClick(event:MouseEvent):void
		{
			...
			{
				var itemCloseEvent:ItemClickEvent=new ItemClickEvent(DockViewEvent.CLOSED, true, true);
		...
		public function getView():DockView
		{
			var object:DisplayObject=this;
			while (!(object is DockView))
			{
				object=object.parent;
			}
			return DockView(object);
		}
